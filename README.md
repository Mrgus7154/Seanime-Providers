...
Online streaming providers and plugins for [Seanime](https://seanime.app).
...
1. Copy the Install URL of the extension you want
2. Open Seanime → Extensions → Add extension
